...
export const 题材模式配置表: Record<题材模式类型, 题材模式配置> = {
    ...
    末日丧尸: {
        ...
        label: '末日丧尸',
        shortLabel: '末日',
        hint: '现代秩序崩塌后的感染机制、生存物资、噪音风险、营地政治和地下黑市。',
        group: 'apocalypse',
        worldDefaults: {
            worldName: '灰潮纪元',
            worldSize: '九州宏大',
            dynastySetting: '现代城市秩序因感染潮崩塌，幸存者营地、军方残部、掠夺团、医疗机构遗址、黑市网络和教团聚落争夺物资、通行权与安全区。',
            sectDensity: '稀少',
        ...
        dynastyLabel: '灾后秩序格局',
        dynastyHint: '幸存者营地、军方残部、掠夺团、医疗遗址、黑市网络、教团聚落、物资点和感染区。',
