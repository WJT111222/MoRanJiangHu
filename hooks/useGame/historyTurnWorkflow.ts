...
type 历史回合工作流依赖 = {
    ...
    执行正文润色: (response: GameResponse, rawSource: string, options?: { manual?: boolean; playerInput?: string; signal?: AbortSignal }) => Promise<{ applied: boolean; response: GameResponse; error?: string }>;
    规范化游戏设置: (raw?: any) => any;
