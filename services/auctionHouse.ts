...
const 无限流模板池: 拍卖模板[] = [
    { 名称: '急救针剂', 类型: '消耗品', 品质: '良品', 描述: '主神空间标准化急救针，可快速止血并恢复少量体力。', 标签: ['医疗物资', '团队兑换'], 价格: 500, 出现原因: ['团队商城库存刷新，基础急救针剂被大量兑换。'] },
    { 名称: '低级强化药水', 类型: '消耗品', 品质: '上品', 描述: '淡蓝色液体，服用后可小幅提升某项基础属性。', 标签: ['强化药剂', '团队兑换'], 价格: 3200, 出现原因: ['团队商城推出限时折扣，强化药水兑换量激增。'] },
    ...
    { 名称: '基因锁抑制器', 类型: '消耗品', 品质: '极品', 描述: '可暂时压制基因锁开启后的身体崩溃，副作用未知。', 标签: ['基因锁辅助', '高级药剂'], 价格: 18000, 出现原因: ['团队商城限量发售，被少数精英轮回者抢购后转手。'] },
    { 名称: 'C级支线剧情卷轴', 类型: '消耗品', 品质: '极品', 描述: '承载一段C级支线剧情的凭证，可用于兑换高级强化。', 标签: ['支线剧情', '稀缺资源'], 价格: 25000, 出现原因: ['某轮回者完成隐藏任务后出售多余支线剧情凭证。'] },
    { 名称: '精神力恢复药剂', 类型: '消耗品', 品质: '上品', 描述: '银色小瓶，服用后可快速恢复精神力消耗。', 标签: ['精神力辅助', '消耗品'], 价格: 2800, 出现原因: ['精神系能力者清仓时将多余药剂挂入团队商城。'] },
    { 名称: '初级血统强化液', 类型: '消耗品', 品质: '绝世', 描述: '暗红色浓缩液体，可激活微量血统因子。', 标签: ['血统强化', '高级兑换'], 价格: 55000, 出现原因: ['团队商城高级区出现一批来路不明的血统强化液。'] },
...
const 无限流行情模板: Array<Omit<拍卖行情, 'ID' | '过期时间'>> = [
    ...
    { 标题: '团队补货', 描述: '团队商城大规模补货，基础物资价格小幅回落。', 影响类型: '消耗品', 价格倍率: 0.92, 热点标签: '团队补货' },
];
    ...
    const sellerPool = profile.group === 'apocalypse'
        ...
        : profile.group === 'modern'
            ...
            : profile.group === 'infinite'
                ? ['团队商城', '轮回者寄售', '小队后勤', '任务世界商人', '主神空间交易区']
