...
1. **市场语义识别**：
   ...
   - 优先识别世界规划、世界大事、其他宗门/门派/商会/镖局的交易、攻杀、劫镖、缴获、库藏流出等背景导致的市场流通
   - 聚焦主角或当前 NPC 的私密主线剧情不应自动变成拍卖行货源，除非文本明确说玩家主动寄售/上架/送入拍卖行
...
- 如果文本只是当前剧情人物手中、身边、房间里的东西，不能因为它“出现了”就进入拍卖行
- 更合理的拍卖行来源应来自世界大事、其他宗门/商会/镖局/官府/黑市等势力演化造成的交易、缴获、抄没、转卖或库藏流出
