...
const 运行时配置分区列表: 运行时配置分区[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            { label: '市场行情模板 JSON（可选）', path: ['economy', 'marketEventTemplates'], type: 'json', expectedShape: 'array', placeholder: '[{"标题":"节礼采买","描述":"年节将近，衣料首饰行情看涨。","影响类型":"杂物","价格倍率":1.2,"热点标签":"节礼采买"}]' },
    ...
    },
    {
        title: '界面文案覆盖',
        fields: [
            { label: 'UI 文案覆盖 JSON（可选）', path: ['uiLabels'], type: 'json', expectedShape: 'object', placeholder: '{"菜单":{"inventory":"随身箱笼"},"标题":{"背包":"随身箱笼"},"组织":{"能力库":"家塾书房"},"资源":{"能量":"心气"},"档案":{"档案题头":"府中人物档案"},"能力类别":{"招式":"才艺章法"},"向导":{"worldSizeLabel":"红楼版图"}}' }
        ]
    },
    {
        title: '校验系统',
