...
export const 预置物品图片列表: 预置物品图片条目[] = [
    ...
    // ─── 现代/末日/无限流高频开局物品兜底图 ─────────────────────────────
    { 名称: '随身短刃', 类型: '武器', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/7DAumvaZPI8hCRhH6dyiKvH9LL9rohi6.jpg' },
    { 名称: '门禁卡', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/DzKhElzTrSHNz31IYQ7a1NF9YDCyInrN.jpg' },
    { 名称: '身份证件', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/WDNkBTdzf0bwFRBjxmupIkZA9kXnrVD7.jpg' },
    { 名称: '充电宝', 类型: '材料', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/1Feq0nJ77mjRGMbtHNZjqzFLbbwaNInw.jpg' },
    { 名称: '便携药盒', 类型: '消耗品', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/IMC3q4enrT78qeYOSjggkMwHBuOLprcT.jpg' },
    { 名称: '调查相机', 类型: '杂物', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/3rs0EcI9pv0Rg2FeqwIaBGNrOPKOZ644.jpg' },
    { 名称: '钥匙串', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/kor2lnXBbNgU4QIhrsFuQcQpmzNPMtqV.jpg' },
    { 名称: '出租屋租约', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/gAjfghMTc5yW9Pib8h0XXXa7gXEoaSYu.jpg' },
    { 名称: '记事本', 类型: '秘籍', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/ZrRkCtvGLs8S3itKu6LPlUzOJNIWjuK0.jpg' },
    { 名称: '手机充电线', 类型: '材料', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/EmFdq8rzORvoBs7QaQAWk8KrBzqlKAJX.jpg' },
    { 名称: '交通卡', 类型: '杂物', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/JtekNPJni2KVr7ban46XxdciL43bIwFF.jpg' },
    { 名称: '防水雨衣', 类型: '防具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/HNoBifKqfrFgegMfaok5KECXcGeD2H21.jpg' },
    { 名称: '应急药箱', 类型: '消耗品', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/QyD5x3qMxUIHSD0HL7lJbypRhJck3maT.jpg' },
    { 名称: '瓶装水', 类型: '消耗品', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/IleSbgJoutHGicbmzBv4B532B2fBSbNd.jpg' },
    { 名称: '口粮包', 类型: '消耗品', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/ynU115jAhGAQnewt2aUnBFXK7ljmmY8y.jpg' },
    { 名称: '破窗锤', 类型: '武器', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/ratqlMLTAIyVjx4cXhp8YZim7S6JLTg8.jpg' },
    { 名称: '对讲机', 类型: '杂物', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/LBWmso4b4aPiHFseIuHDY3mmqdzFZkSN.jpg' },
    { 名称: '胶带卷', 类型: '材料', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/e4bx2oP0dF2dvSfReLXYD6RudS9SdP3P.jpg' },
    { 名称: '消毒喷雾', 类型: '消耗品', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/04aWTl5qdgx78dXy3BxrGCAIk9nKTTRr.jpg' },
    { 名称: '防割外套', 类型: '防具', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/pTnoELY5WSaBGMHd5bP8HgEBmXCaFgBs.jpg' },
    { 名称: '一次性手套', 类型: '防具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/CWd4YNUXUefVrYlCBpabvjYaUf2iPTXy.jpg' },
    { 名称: '柴油桶', 类型: '材料', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/4lBl7m80cpDLU2QYWKRiAXMFBjfX7BiX.jpg' },
    { 名称: '感染记录本', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/68e2FDJiZjbHaVblgfquXTEWCjXYdRSk.jpg' },
    { 名称: '打火机', 类型: '杂物', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/3XyN1qN6FzPoPe2QkUld4lBKH35mqLc2.jpg' },
    { 名称: '任务腕表', 类型: '饰品', 品质: '上品', 图片URL: 'https://cdn.nodeimage.com/i/Oa0B39tbF5ylmlTrqRuRp9OYzh13ivdS.jpg' },
    { 名称: '奖励点凭证', 类型: '任务道具', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/lpwmIEE6DhYmmkDhBUmD5WclYMTvH4Xj.jpg' },
    { 名称: 'D级支线剧情凭证', 类型: '任务道具', 品质: '上品', 图片URL: 'https://cdn.nodeimage.com/i/EoNS0Fdp9tDxszBa0n81oWG1QBXZwAz4.jpg' },
    { 名称: '主神任务卡', 类型: '任务道具', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/D0dS49Uau12Q77l0vDn1PEOmBEBn2d6n.jpg' },
    { 名称: '主神兑换券', 类型: '任务道具', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/Rk9GvhQjeatwM2kh9jGjQJz0xjYb0GOp.jpg' },
    { 名称: '剧情地图碎片', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/FxBns38CaelUTKQtvQJ8FUGupLW4MUo8.jpg' },
    { 名称: '备用弹匣', 类型: '材料', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/SkQa2rlnZ04wVTvX3s36u6xfZaChGdx8.jpg' },
    { 名称: '通讯耳麦', 类型: '杂物', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/L9aY5s5D5EPjttXVsKiczXTzUYpjGAAi.jpg' },
    { 名称: '强光手电', 类型: '杂物', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/7UJKqJcosUyZABKL9sJMGpxizLxuuZ4g.jpg' },
    { 名称: '便携扫描仪', 类型: '杂物', 品质: '上品', 图片URL: 'https://cdn.nodeimage.com/i/byKXlnzGFJCnwW17g960WqM1Nzo4nYYK.jpg' },
    { 名称: '轮回者身份铭牌', 类型: '任务道具', 品质: '良品', 图片URL: 'https://cdn.nodeimage.com/i/nxKc9wzphhBlfv1tSg2wLFQfoNlzD1vB.jpg' },
    { 名称: '安全屋钥匙', 类型: '任务道具', 品质: '凡品', 图片URL: 'https://cdn.nodeimage.com/i/4thUPSFOhZ0hvigtBPu2M8iRGYKq8zLI.jpg' },
    // ─── 杂物/通用 ─────────────────────────────────────────────────────
