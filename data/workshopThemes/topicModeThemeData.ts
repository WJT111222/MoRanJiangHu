...
export const 题材模式配置表: Record<题材模式类型, 题材模式配置> = {
    ...
    无限流: {
        ...
        worldDefaults: {
            ...
            worldExtraRequirement: '本局为无限流：市场入口必须称为团队商城，核心货币是奖励点，关键高级兑换还需要D/C/B/A/S级支线剧情；任务奖励由主神按主线任务、支线任务、存活、击杀或隐藏贡献结算。不得把经济写成银子、灵石、人民币或门派贡献。'
        },
        worldSizeLabel: '轮回规模',
        ...
        auctionName: '团队商城',
        marketVerb: '进入主神兑换列表',
        currencyPrompt: '所有兑换、强化、修复、造人和高级物资交易都通过团队商城结算，基础货币为奖励点，高级项目必须消耗对应等级支线剧情；不要使用银子、铜钱、灵石、人民币或门派贡献。',
        ...
        promptLines: [
            ...
            '市场、强化、修复和兑换入口必须称为团队商城；奖励点是基础货币，D/C/B/A/S级支线剧情是稀缺高级门槛，不要混用银钱、灵石、宗门贡献或现实工资作为核心经济。',
