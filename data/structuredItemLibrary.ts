...
const 现代预设物品: 结构化物品条目[] = [
    ...
    { 名称: '出租屋租约', 物品: '租约', 类型: '任务道具', 品质: '凡品', 视觉标签: ['rental contract', 'urban document'], 生图描述: 'modern rental agreement pages in a folder with abstract unreadable lines, no real text' },
