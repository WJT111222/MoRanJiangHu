...
${构建修炼体系附加块([
`   - 本存档世界必须兼容当前项目“累计境界值”${是否仙侠开局模式(openingConfig) ? '仙侠修真' : 题材配置.label}成长体系。`,
...
6. 势力格局
   ...
   - 每个势力有代表性的物品风格描述；物品池必须贴合${题材配置.label}，参考：${题材配置.presetItemKeywords.join('、')}。
   - 势力之间的关系网是世界演化和${题材配置.auctionName}物品流通的基础。
